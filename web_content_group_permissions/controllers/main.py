...
class BinaryGroupPermissions(Binary):
    ...
    def content_common(self, xmlid=None, model='ir.attachment', id=None, field='raw',
                       ...
                       download=False, access_token=None, nocache=False, **kw):
            ...
            if attachment.exists():
                ...
                if allowed_groups and not (allowed_groups & user.groups_id):
                    _logger.info(
                        ...
                        attachment.name, user.name
                    )
                    raise AccessDenied(_("You don't have permission to access the requested resource."))
