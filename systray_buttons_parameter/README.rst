...
New buttons are dynamically imported from system parameters where the key value
contains the word 'systray'.

Configuration
=============
Define system parameters to include buttons in the systray.
